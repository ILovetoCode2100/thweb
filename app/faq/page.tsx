...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "I hold a Diploma in Clinical Hypnotherapy (DipCH) and am a registered member of the National Council for Hypnotherapy (NCH). This body requires adherence to a strict code of ethics, continuous professional development, and full professional insurance, all of which I maintain.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Absolutely. Confidentiality is paramount and is a cornerstone of my ethical commitment to you. Everything we discuss is held in the strictest confidence, in line with the codes of conduct of my registering body.",
  },
  {
    ...
    <>
      <section className="pt-32 pb-0">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="mb-6 text-primary">Frequently Asked Questions</h1>
            <p className="lead">Find answers to common questions about hypnotherapy and my practice.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="pt-0 pb-20">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          >
            <h3 className="mb-4">Have More Questions?</h3>
